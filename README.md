...
The data is from Kaggle, you can find the link to the data [here](salaries.csv). It includes key information from the past 5 years such as  
...
## Dashboard File
You can find the final dashboard [here](Project_Dashboard.xlsx)
