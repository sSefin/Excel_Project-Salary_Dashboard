...
The data is from [Kaggle](https://www.kaggle.com/datasets/adilshamim8/salaries-for-data-science-jobs/data), you can find the link to the data [here](https://github.com/sSefin/Excel_Project-Salary_Dashboard/raw/main/salaries.csv). It includes key information from the past 5 years such as  
